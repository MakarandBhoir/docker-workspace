...
```bash
docker run -d --name container-example-02 --rm -p 8080:80 nginx:latest
```
...
```bash
docker logs container-example-02
```
...
## Stop the container
```bash
docker stop container-example-02
```

## Additional details  
- Container name: `container-example-02`  
